...
public static partial class Log
{
    public static class Entries
    {
        ...
        {
            _years = DataAccess.GetYears("Entries", sender).OrderDescending().ToList();
        ...
        {
            return DataAccess.EditDataInEntries(entry.ID, entry.Type, entry.BeginTime.ToString("yyyy-MM-dd HH:mm:ss"), entry.EndTime.ToString("yyyy-MM-dd HH:mm:ss"), entry.Localization, entry.Description, entry.Earning);
        }
